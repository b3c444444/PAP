    ...
    <section id="Controledeacesso" class="Controledeacesso">
      <div class="container" data-aos="fade-up">
        ...
        if (isset($_POST['searchinput']) && $_POST['searchinput'] != "") {
          ...
          if ($id_tp != 2) $sql = "SELECT id_pessoa, nome, Telemovel, Email FROM pessoa WHERE Nome LIKE ?";
          ...
          if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              echo "<td><form method='post' action='MedicalNotesInfos.php'><input type='hidden' name='ID_PessoaX' value='$ID'><button class='acess-btn'>";
              echo "FichaMedica";
              echo "</button></form></td>";
